...
<head>
    ...
    <title>Trang Quản Lý Đặt Vé - Admin</title>
</head>
<body>
    <div class="wapper">
                        ...
                        <div class="container mt-3">
                            ...
                            <div class="table-responsive shadow">
                                ...
                                if (!$mysqli) {
                                    ...
                                    $lietke_sql = "SELECT tblbooking.Iddattour, tbltour.Hinhanhtour, tblbooking.Tenkh, tblbooking.Sdtkh, tblbooking.Email, tbltour.Tentour, tbltour.Loaitour, tblbooking.Ngaydi, tblbooking.Ngayve FROM tblbooking JOIN tbltour on tblbooking.Idtour = tbltour.Idtour";
                                    ...
                                    {   ?>
                                    <tr>
                                    <td><?php echo $row['Iddattour'];?></td>
                                    <td><img class="image" src="images/<?php echo $row['Hinhanhtour'];?>" alt=""></td>
                                    <td><?php echo $row['Tenkh'];?></td>
                                    <td><?php echo $row['Sdtkh'];?></td>
                                    <td><?php echo $row['Email'];?></td>
                                    <td><?php echo $row['Tentour'];?> - <?php echo $row['Loaitour'];?></td>
                                    <td><?php echo $row['Ngaydi'];?>/ <?php echo $row['Ngayve'];?></td>
                                    </tr>
                                    <?php }} ?>
                                </tbody>
                                </table>

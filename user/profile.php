...
if(isset($_POST['update'])){
    ...
    $update_sql = "UPDATE user_form SET name='$name', sdt='$sdt', email='$email'";
...
<div class="container-flush bg-info">
    ...
    <div class="container py-5">
        <div class="bg-white p-3  shadow">
            <div>
                <h3 class="pb-3">Thông tin tài khoản</h3>
            </div>
            <?php
            ...
            <div class="mb-3">
                <label class="form-label h6" style="font-size: 1.5rem">Họ Và Tên</label>
                <input class="form-control" style="font-size: 1.3rem" type="text" name="name" value="<?php echo$row['name'] ?>">
            </div>
            <div class="mb-3">
                <label class="form-label h6" style="font-size: 1.5rem">Số Điện Thoại</label>
                <input class="form-control" style="font-size: 1.3rem" type="number" name="sdt" value="<?php echo$row['sdt'] ?>">
            </div>
            <div class="mb-3">
                <label class="form-label h6" style="font-size: 1.5rem">Số Điện Thoại</label>
                <input class="form-control" style="font-size: 1.3rem" type="text" name="email" value="<?php echo$row['email'] ?>">
            </div>
            <?php }} ?>
                <button type="submit" name="update" class="btn-primary btn shadow" style="font-size: 1.5rem">Sửa</button>
                <button type="reset" class="btn-inverse btn shadow mx-2" style="font-size: 1.5rem">Reset</button>
            </form>
        </div>
    </div>

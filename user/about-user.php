...
<body>
    ...
    <div class="heading" style="background:url(images/img-slide-1.jpg) no-repeat">
    ...
    <section class="about">
        ...
        <div class="content ">
            <h3>tại sao bạn chọn chúng tôi?</h3>
            <div class="ps-4" style="font-size: 1.4rem;">
                <h4>1. Đa Dạng Tour Du Lịch</h4>
                <h4>2. Dịch Vụ Chuyên Nghiệp</h4>
                <h4>3. Ưu Đãi và Khuyến Mãi Hấp Dẫn</h4>
                <h4>4. Đặt Tour Trực Tuyến Nhanh Chóng và Tiện Lợi</h4>     
            </div>
            
            <div class="icon-container">
                <div class="icons">
                    <i class="fas fa-map"></i>
                    <span>Địa Điểm Hấp Dẫn</span>
                </div>
                <div class="icons">
